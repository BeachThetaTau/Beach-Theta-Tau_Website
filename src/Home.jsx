...
const Home = () => {
    ...
    return (
        <div className="container">
            <h1 className="text-center mt-3">Welcome to Theta Tau Xi Epsilon Chapter</h1>
                ...
                {user ? (
                    <div>
                        ...
                        <div className="d-grid gap-2">
                            <button type="submit" className="btn btn-primary pt-3 pb-3" onClick={logoutUser}>Logout</button>
                        </div>
                    </div>
                    ) : (
                    ...
                    <div>
                        ...
                        <div className="d-grid gap-2">
                            <Link to="/login" className="btn btn-primary pt-3 pb-3">Login</Link>
                        </div>
                    </div>
                )}
                </div>
