  ...
  return (
    <div className={`fade-in-section ${isInView ? 'fade-in-active' : ''}`} ref={sectionRef}>
      <ul className={`image-list fade-in-list ${isInView ? 'fade-in-active' : ''}`}>
        <li>
          <img src="Divergent.png" alt="Divergent" className="company-logo" />
        </li>
        <li>
          <img src="NorthropGrumman.png" alt="Northrop Grumman" className="company-logo" />
        </li>
        <li>
          <img src="Boeing.png" alt="Boeing" className="company-logo" />
        </li>
        <li>
          <img src="Benchmark.png" alt="Benchmark Electronics" className="company-logo" />
        </li>
      </ul>
      ...
      <ul className={`image-list fade-in-list ${isInView ? 'fade-in-active' : ''}`}>
        ...
        <li>
          <img src="J&J.png" alt="Johnson & Johnson" className="company-logo" />
        </li>
      </ul>
      ...
      <ul className={`image-list fade-in-list ${isInView ? 'fade-in-active' : ''}`}>
        ...
        <li>
          <img src="Kaiser.png" alt="Kaiser Permanente" className="company-logo" />
        </li>
        <li>
