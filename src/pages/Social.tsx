  ...
  return (
    <>
      ...
      <div className="social-body-container">
        ...
        <img src="BlankImg.png" alt="Regionals Image" className="social-img" />
      </div>
      ...
      <div className="social-body-container">
        ...
        <div className="social-txt-container">
          ...
          <p className="social-txt">
            We cherish connections that go beyond our chapter. Regionals are the
            pulse of our regional network, bringing chapters together for a
            weekend of camaraderie, fun, and meaningful connections. Hosted by
            different chapters, Regionals offer a chance to meet new people,
            build lasting friendships, and grow professional networks. With
            workshops and competitions, Regionals celebrate our values,
